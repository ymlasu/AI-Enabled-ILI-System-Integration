'''
Raspberry Pi 3B+ with HATs - Code for PS4 Controller 
Author: Gowtham Dakshnamoorthy
Full Repo Link with further details and older versions: https://github.com/gowthamdakshnamoorthy/PARA-Lab-Works
'''
